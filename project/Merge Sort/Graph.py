...
def Execute_Kernel_Code(c_code_path, mode):
    ...
    if mode == "cpu":
        ...
        compile_command = "gcc {} -o executable".format(c_code_path)
...
if __name__ == "__main__":
    ...
    for i in range(10): # runnign the CPU kernel code for 10 times
        ...
        total_time = Execute_Kernel_Code("Merge.c", mode="cpu") # returning the total execution time
    ...
    for i in range(10): # running Sequential code for 10 times
        ...
        total_time = Execute_Kernel_Code("SEQ_Merge_Sort.c", mode="seq") # returning the total execution time
